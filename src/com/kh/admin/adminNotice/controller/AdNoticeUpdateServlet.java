...
/**
 * Servlet implementation class AdNoticeUpdateServlet
 */
@WebServlet("/noticeUpdate.ad")
public class AdNoticeUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdNoticeUpdateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			int result = new AdNoticeService().adNoticeUpdate(n, at, mid);
