...
/**
 * Servlet implementation class AdNoticeListServlet
 */
@WebServlet("/noticeList.ad")
public class AdNoticeListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdNoticeListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new AdNoticeService().adNoticeListCount();
		...
		ArrayList<Notice> list = new AdNoticeService().adNoticeList(pi);
		...
		RequestDispatcher view = request.getRequestDispatcher("views/admin/adminInquiry/adminNoticeList.jsp");
