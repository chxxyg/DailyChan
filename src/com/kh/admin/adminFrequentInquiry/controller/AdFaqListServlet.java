...
/**
 * Servlet implementation class AdFaqListServlet
 */
@WebServlet("/faqList.ad")
public class AdFaqListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdFaqListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new AdFaqService().adFaqListCount();
		...
		ArrayList<FrequentInquiry> list = new AdFaqService().adFaqList(pi);
		
		// adminFaqControl페이지에 보내줌
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
		
		RequestDispatcher view = request.getRequestDispatcher("views/admin/adminInquiry/adminFaqControl.jsp");
