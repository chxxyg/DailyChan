...
public class AdDiscountSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new AdDiscountService().adDissCount(productCode);
		...
		ArrayList<AdDiscount> list = new AdDiscountService().searchDiscount(pi,productCode);
		...
		if(list.isEmpty()) {	
			...
			request.getRequestDispatcher("views/admin/adminDiscount/adminDiscountSearch.jsp").forward(request, response);	
