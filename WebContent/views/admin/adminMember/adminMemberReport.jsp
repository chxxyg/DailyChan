...
<body>
    ...
    <div id="adproduct">
      <div class="outer">
        ...
        <div id="allcount">
                <div style="width:30%;">총 내역 :  <input type="text" id="adproductcount"> 개</div>
                <div style="width:70%; text-align:right;"><button onclick="">신고누적보기</button> <button>선택삭제</button></div>
        </div>  
        <table class="listMember">
            <thead>
                <tr>
                    ...
                    <th width="50">번호</th>
                    <th width="120">신고 시간</th>
                    <th width="350">신고 내용</th>
                    <th width="100">아이디</th>
                    <th width="100">신고자</th>
