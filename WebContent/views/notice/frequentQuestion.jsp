		...
		<div class="cst_top">
	           ...
	           <form id="topForm" method="get" action="<%=contextPath%>/Frequestion.fq">
		        	<dl>
		                ...
		                <button type="submit" id="topSearchBtn" class="bt_sch"><em>검색</em></button>
					...
					<li class="on">
						...
						<a name="tab_con2" class="tab t2">주문/취소</a>
						   <div class="content1">
								...
								해당 제품의 유통기한 이내 마이페이지 1:1친절상담 또는 고객센터(1644-6844)로 연락주시기 바랍니다.
								
								다만, 고객님의 단순변심, 주문 실수, 개인 기호 등의 경우 교환 및 반품은 불가합니다. 데일리찬의 제품은 신선식품, 냉장/냉동식품으로 제품가치 하락으로 재판매가 불가합니다.
								...
								** 주문마감 시간 : 희망배송일 전일 1차마감 6시, 2차마감 13시 
								...
								- 홈페이지를 통한 주문 : 데일리찬 홈페이지를 이용하여  상품구매 가능.
								
								2. 이용방법
								
								- 데일리찬 회원가입 → 원하는 상품을 선택 → 주문서작성 (배송방법/ 희망배송일 지정) →결제완료(주문완료).<br>
