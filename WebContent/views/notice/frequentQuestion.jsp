					...
					<li class="on">
						...
						<a href="#tab_con3" class="tab t3" data-prop_dtl_no="14">배송</a>
						 <div class="content1">
					            ...
					            <div class="q">직접수령이 가능한가요?</div>
					            <p class="content">
					            	더반찬의 가산DSCK공장은 직접수령이 불가능합니다.
									위생, 안전, 품질 관리로 인하여 외부인의 출입을 제한하고 있기에 직접 수령은 불가하오니, 고객님들의 너그러운 양해 부탁드립니다.
					            </p>
					
					            <div class="q">새벽배송의 필수정보 사항 오기재 및 미기재시 어떻게 배송하나요?</div>
					            <p class="content">새벽직배송 필수정보사항 오기재 및 미기재시는 희망배송일 전일 오후 6시이전(고객센터 운영시간:월~금0900~18:00) 고객센터로 유선 및 1:1문의로 수정내용을 남겨주시면 위탁배달점으로 직접 전달하고 있습니다.
									또한 배송지 주소, 공동현관문 비밀번호, 오기재 (미기재)로 인한 배송오류는 당사가 책임지지 않습니다.</p>
					            
					            <div class="q">배송지 주소 및 연락처 변경이 가능한가요?</div>
					            <p class="content">
					            	주문서 상태가 결제완료시에 배송지와 연락처 변경이 가능합니다.
									고객센터 운영시간(월~금/ 09:00~18:00)내에 연락을 주시면 변경하여 드리겠습니다.
									주문마감시간이후 제품준비중으로 상태가 변경된 경우 수정이 불가능합니다.
					            </p>
					            <div class="q">관공서, 학교(기숙사), 회사, 시장, 백화점도 새벽직배송 가능한가요?</div>
					            <p class="content">밤 9시부터 오전 7시사이 건물의 공동현관을 폐쇄하거나, 출입 제한(카드키로만 출입이 가능한 공동현관)이 있는 곳은 새벽배송이 어렵습니다.
						...
						<a href="#tab_con4" class="tab t4" data-prop_dtl_no="21">쿠폰/기타</a>
						 <div class="content1">
					            ...
					            <div class="q">적립금 사용기한은 어떻게 되나요?</div>
					            <p class="content">1) 상품 이용후 지급되는 적립금.
					            ...
					            <div class="q">적립금은 어떻게 사용하나요?</div>
					            <p class="content">적립금 사용은 주문시 주문서→할인및혜택→보유 적립금에서 10원 단위부터 사용이 가능합니다.

								적립금 조회는 마이페이지→구매혜택→적립금 조회에서 가능합니다.</p>
					
					            <div class="q">주문중에 쿠폰이 사라졌어요!</div>
					            <p class="content">고객센터(1234-5678)로 문의주시기 바랍니다.</p>
					
					            <div class="q">쿠폰사용기간은 얼마나 되나요?</div>
					            <p class="content">데일리찬 쿠폰은 쿠폰마다 유효기간 및 사용조건이 상이하오니, 쿠폰별 유효기간을 확인하시고 사용하시기 바랍니다.

								쿠폰별 유효기간 및 사용조건 확인은 마이페이지→구매혜택→쿠폰조회 에서 확인 가능합니다.<br>
								</p>
							            
					            <div class="q">상품평 후기 작성은 어디서 하나요?</div>
					            <p class="content">데일리찬 홈페이지 로그인→마이페이지 →주문/배송조회→수취확인→고객후기작성에서 가능합니다.
						...
						<a href="#tab_con5" class="tab t5" data-prop_dtl_no="31">회원정보</a>
						 <div class="content1">
							...
							<div class="q">아이디/비밀번호를 잃어버렸어요!</div>
					            <p class="content">"1)데일리찬 홈페이지 접속 → 로그인 하단에 표기 되어 있는 아이디/비밀번호 찾기를 통해 빠른확인 가능.
					             2)데일리찬 홈페이지 접속 → 이메일주소를 통해 아이디/ 비밀번호 확인가능. ※ 한메일의 경우 메일발송이 지연되거나 발송이 되지 않을수 있으며, 빠른 확인은 데일리찬 고객센터를 이용해 주세요. "</p>
					
					            <div class="q">비회원도 주문이 가능한가요?</div>
					            <p class="content">데일리찬은 비회원도 주문이 가능 합니다.

									단, 비회원으로 주문하실 경우, 구매하신 금액에 대한 적립금 및 다양한 회원 혜택이 적용되지 않습니다.</p>
					
					            <div class="q">회원탈퇴는 어떻게 하나요?</div>
					            <p class="content">데일리찬 회원 탈퇴는 고객님의 정보보호를 위해 직접탈퇴만 가능하십니다.
						...
						<a href="#tab_con6" class="tab t6" data-prop_dtl_no="80">제품</a>
						 <div class="content1">
					            ...
					            <div class="q">제품의 유통기한과 원산지는 어떻게 되나요?</div>
					            <p class="content">"제품의 상세페이지 상단과 하단 상세정보고시에서 유통기한과 원산지 등의 제품 정보를 확인하실수 있습니다.
									
									제품의 상세정보고시에 유통기한과 보관, 섭취방법이 기재되어 있으며,  유통기한은 제조일을 포함하고 있습니다.
									
									더반찬의 제품은 보존제나 방부제를 사용하고 있지 않기에 유통기한이 짧은 제품이 많습니다. "</p>
														
								<div class="q">재료를 변경/제외 가능한가요?</div>
					            <p class="content">현재 데일리찬은 다양한 제품을 대량 조리하여 일괄적으로 포장/ 출고를 시행 하고 있습니다. 전 과정이 자동화 생산으로 정확한 레시피 규정을 통해 획일적인 품질을 유지 하기 위함으로 고객님의 별도의 요청사항을 수렴하기 어려운 점, 양해 부탁 드립니다.</p>
					
					            <div class="q">일부제품에서 수입산 식재료를 사용하시는 이유가 뭔가요?</div>
					            <p class="content">더반찬에서는 질좋은 국내산, 수입산 식재료를 이용하고 있습니다. 국내산 식재료의 수급이 어렵거나, 품질이 좋지 않은 경우 등의 사유로 수입산 식재료를 적절히 사용하여 품질을 유지하고 있습니다.</p>
