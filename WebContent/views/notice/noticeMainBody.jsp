...
<%@ include file="noticeSearch.jsp" %>
	...
	<div class="outer">
        ...
        <div class="cst_faq">
            ...
            <div class="q"><span class="icon">Q</span>언제 배송 되나요?</div>
            <p class="content"><span class="icon">A</span>더반찬은 지정하신 희망배송일에 일반택배배송, 새벽직배송 두가지 방법으로 배송해드리고 있습니다.

			1) 일반택배배송의 경우 해당 지역의 당일 택배 물량과 배송기사님의 당일 이동노선에 따라 배송시간은 상이합니다. 항상 동일시간대에 배송되지 않는점 참고를 바랍드립니다.
            ...
            <div class="q"><span class="icon">Q</span>새벽배송이 완료되면 문자나 유선(전화) 연락을 주나요?</div>
            <p class="content"><span class="icon">A</span>새벽직배송은 고객님께서 주무시는 희망배송일 전일 오후 10시에서 희망배송일 오전 7시 사이 배송되고 있기에 고객님의 편안한 숙면을 위하여 별도 연락은 드리지 않습니다.
            ...
            <p class="content"><span class="icon">A</span>포장재인 아이스박스는 수거하지 않습니다.<br>
		             ...
		             데일리찬에서도 적극적인 대안마련과 다양한 방법을 찾기 위해 최선을 다하고 있습니다. 번거로우시겠지만, 당분간은 자체 폐기를 부탁드립니다.</p>

            <div class="q"><span class="icon">Q</span>신선식품인데 택배로 받아도 안전한가요?</div>
            <p class="content"><span class="icon">A</span>데일리찬의 제품은 배송시 선도 유지를 위해 얼린 샘물을 동봉하여 아이스박스에 포장하고 있습니다. 얼린 샘물의 수량은 기온에 따라 수량이 변경되고 있습니다. 신선하고 안전하게 배송하겠습니다</p>
