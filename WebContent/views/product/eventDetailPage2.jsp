...
<%@ include file="/views/common/mainSideBar.jsp" %>
    ...
    <table id="eventDetailWrap">
        ...
        <tr>
            <td>
                <div id="eventDetailLabel">
                    <span id="eventDetailTitle">오늘 요리사는 나야 나!</span>
                    <br><br>
        ...
        <tr>
            <td>
                <img id="eventDetailImg" src="<%= request.getContextPath() %>/resources/eventImg/eventImg2.jpg">
            </td>
        </tr>
        <tr>
        	<td>
        		<p id="eventDetailP">
					...
					<b>쿠폰 사용 기한</b> <br>
					<br>
					  - 5000원 할인 쿠폰 : 쿠폰 다운로드 후 7일 이내 <br>
					<br>
					<br>
					<b>* 쿠폰 사용방법</b> <br>
					<br>
					...
					<br>
					<br>
	        		<button type="button" id="couponBtn3" class="couponBtn">5000원 할인 쿠폰 다운로드</button>
        		</p>
        	</td>
        </tr>
    </table>
